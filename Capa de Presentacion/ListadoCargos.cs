...
{
    public partial class ListadoCargos : Form
    {
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBoxEx.Show("Debe Seleccionar la Fila a Editar Datos.", "Sistema de Ventas", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void dataGridView1_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0){
                if (e.KeyChar == 13){
                    ...
                    Resultado = MessageBoxEx.Show("Está Seguro que Desea Editar Está Fila.", "Sistema de Ventas.", MessageBoxButtons.YesNo, MessageBoxIcon.Error);
